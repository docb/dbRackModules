...
__m128 Shaper::process(const __m128 &a,const __m128 &f) {
  switch((Modes)_shapeMode) {
    ...
    case SINEWRAP_MODE:
      sineWrap(a,f);
      break; // Appended here as not to break Dexter
    case BUZZ_X2_MODE:
      buzzX2(a,f);
      break;
    case BUZZ_X4_MODE:
    ...
    case BUZZ_X8_MODE:
      buzzX8(a,f);
      break;
    case WRINKLE_X2_MODE:
      wrinkleX2(a,f);
      break;
    case WRINKLE_X4_MODE:
      wrinkleX4(a,f);
      break;
    case WRINKLE_X8_MODE:
      wrinkleX8(a,f);
      break;
    case SINE_DOWN_X2_MODE:
      sineDownX2(a,f);
      break;
    case SINE_DOWN_X4_MODE:
      sineDownX4(a,f);
      break;
    case SINE_DOWN_X8_MODE:
      sineDownX8(a,f);
      break;
    case SINE_UP_X2_MODE:
      sineUpX2(a,f);
      break;
    case SINE_UP_X4_MODE:
      sineUpX4(a,f);
      break;
    case SINE_UP_X8_MODE:
      sineUpX8(a,f);
      break;
    default:
      bend(a,f);
