...
struct Osc6 : Module {
  ...
  void setParamFromInput(ParamId param,InputId input) {
    if(inputs[input].isConnected()) {
      setImmediateValue(getParamQuantity(param),inputs[input].getVoltage()*3.2f);
    }
  }
